    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 my-5 mb-4 px-4">
                <h2 class="mt-5 pt-4 mb-3 fw-bold"><?php echo $room_data['name']?></h2>
            ...
            <div class="col-lg-5 col-md-12 px-4">
                <div class="card mb-4 border-0 shadow-sm rounded-3">
                    <div class="card-body">
                        <?php
                            echo <<<price
                                <h4>৳$room_data[price] Every Night</h4>
                            price;
                            ...
                            $features_data = "";
                                ...
                                echo<<<guests
                                    <div class="mb-2">
                                        ...
                                        <span class="badge bg-light text-dark text-warp me-1 mb-1">
                        ...
                        if (!$setting_q['shutdown']){
                            ...
                            echo<<<book
                                        <button onclick='checkLoginToBook($login,$room_data[id])' class="btn w-100 text-white bg-2 shadow-none mb-1">Book Now</button>
                                 book;
                        }
                        ?>
